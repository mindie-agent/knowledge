...
CASES: list[dict] = [
    ...
    },
    {
        ...
        "windows": "not_verified",
        "npu": "not_applicable",
        "source": "tests/fixtures/retrieval-evaluation.json",
        "question": "Query nonexistent_operator_zz991 must not invent a hit.",
        "labels": ["no_hit"],
        "notes": "Authored retrieval fixture, labelled as not independently validated NPU behavior.",
    },
    {
    ...
    },
    {
        ...
        "npu": "not_executed_this_round",
        "source": "tests/fixtures/retrieval-evaluation.json",
        "question": "A failed task that correctly discarded an eager-vs-graph hypothesis is not unhelpful merely because the task failed.",
        "labels": ["failure_hypothesis_excluded"],
        "notes": "Fixture documents (aclgraph.md / eager.md) are authored scenarios, not device runs.",
    },
    {
        "id": "abc-protocol",
        "family": "effect_evidence",
