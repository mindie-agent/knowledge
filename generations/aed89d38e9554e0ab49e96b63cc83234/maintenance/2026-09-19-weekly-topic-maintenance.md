...
- **Export (final)**: generation `077f3efad4fa4b85b51d4adc4895bfd6`；manifest `34623c059160d7c1fa669c026b04bc8232e222ea6f2dc22454056eefdab4ae59`；snapshot `00bb64fa49523f45eb1fc08552f8e5529687ee94967d6e608072b8a561f835fc`；verified
- **Publish path**: locked helper exit 0 twice（topics+weekly → tip `363bee7174774b96b2fd51b95f1c5a048bbf1d5f`；then maintenance outcome fill-in → tip `4a79da032b0892f5c90c2a05646f2c59d0179f4f`）
- **Final org tip**: `4a79da032b0892f5c90c2a05646f2c59d0179f4f` on `mindie-agent/knowledge` / `knowledge/vllm-ascend`（prior daily `caab5632a87516b19957be40172ceda20fbfd768`）
- Package pin: `cc1a1d76fdee2c90b129f6ba56c171d500c158af`
- Note: feed tip `4a79da0…` already carries the post-first-publish outcome text；this local section adds the final tip SHA without a third publish churn
