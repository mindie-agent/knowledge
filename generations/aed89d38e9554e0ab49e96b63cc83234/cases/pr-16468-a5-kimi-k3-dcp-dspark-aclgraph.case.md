...
- **日期**: 2026-09-20（日更修订）；MindIE acceptance 2026-09-18；初建 2026-09-15
- **状态**: OPEN **draft** / **CONFLICTING·DIRTY** / reference-only；超大 PR（+121002/−1763，603 files）
...
- **Pinned（本轮 gh 2026-09-20）**: base `9ad52992c9682f4f640048eb0753f5626e475d50` · head `9410826abb3917f7bcd6e9ab7f7a53cc4923004e`


## 修订说明 / Revision notes（2026-09-20，Asia/Shanghai）

- **重 pin**：base `bdd53a2ac7da…` → `9ad52992c9682f4f640048eb0753f5626e475d50`（与 #16545 MegaMoe **mergeCommit** 同 SHA — VERIFIED）；head `0344beea2a23…` → `9410826abb3917f7bcd6e9ab7f7a53cc4923004e`。
- tip commits（VERIFIED）：`7371232ac9a9…` integrate A5 K3 graphs；`d6968b7e08f2…` A5 MLA C8 and direct DCP output；`9410826abb39…` bounded non-absorbed A5 MLA prefill。
- 规模再膨胀：+121002/−1763，**603 files**（上轮 +87751/−1709，445 files）；仍 **draft + DIRTY/CONFLICTING**。
- 验收 / 性能仍 **CLAIM**；experimental not-to-merge **CLAIM**；本轮未跑 NPU。
- 保留旧对比：https://github.com/vllm-project/vllm-ascend/compare/bdd53a2ac7dadf6e662f8e3106fa0a2f54aca9e7...0344beea2a231896cc460e266f3cb36495de8dd0
- 本轮对比：https://github.com/vllm-project/vllm-ascend/compare/9ad52992c9682f4f640048eb0753f5626e475d50...9410826abb3917f7bcd6e9ab7f7a53cc4923004e
