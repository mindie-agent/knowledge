...
- **Pinned（本轮 gh 2026-09-20）**: base `b255ab59662d8c665e5534e926f913b1c1179b1c` · head `7ae1df8dc3d6d5b6a7ed06e7db26c07bc83e8ccd`

## 修订说明 / Revision notes（2026-09-20，Asia/Shanghai）

- **重 pin**：base `e1d1490314ee…` → `b255ab59662d8c665e5534e926f913b1c1179b1c`；head `b5cc342f6dff…` → `7ae1df8dc3d6d5b6a7ed06e7db26c07bc83e8ccd`。
- tip commit（VERIFIED）：`7ae1df8dc3d6…` `refactor(glm5next): use external CANN KeyPool operators`（2026-09-20T00:42:59Z）。
- **状态**：上轮 CONFLICTING/DIRTY → 本轮 MERGEABLE **BLOCKED**；labels 现含 `documentation,module:tests`（无 merge-conflicts）。
- 规模剧变：约 +576/−142，**8 files**（上轮曾 +27k / 71 files vendored）——文件面转向外部 CANN ops（`indexer_kpool.py`、`sparse_attn_indexer_kpool.py`、docs/UT），不再以 vendored `csrc/attention/key_pool/**` 为主（VERIFIED sample）。
- 仍无充分 device-executing 验收宣称 → 运行时正确性 **UNVERIFIED**；本轮未跑 NPU。
- 保留旧对比：https://github.com/vllm-project/vllm-ascend/compare/e1d1490314eeb5baec2e77b27a9610e5358aa153...b5cc342f6dffb3dfd8141eb7ca3c8dbde91bffde
- 本轮对比：https://github.com/vllm-project/vllm-ascend/compare/b255ab59662d8c665e5534e926f913b1c1179b1c...7ae1df8dc3d6d5b6a7ed06e7db26c07bc83e8ccd
...
- base `main` @ `b255ab59…`；head @ `7ae1df8d…`。
...
**条件**: head `7ae1df8dc3d6d5b6a7ed06e7db26c07bc83e8ccd`；OPEN blocked；external CANN KeyPool；NPU **UNVERIFIED**。
