...
ENV_CONFIG = "MINDIE_KNOWLEDGE_CONFIG"
ENV_CORPUS = "MINDIE_KNOWLEDGE_CORPUS"
ENV_LAYER_ROOTS = {
    "shared": "MINDIE_KNOWLEDGE_SHARED_ROOTS",
    "project": "MINDIE_KNOWLEDGE_PROJECT_ROOTS",
    "candidate": "MINDIE_KNOWLEDGE_CANDIDATE_ROOT",
}
ENV_ENABLED_LAYERS = "MINDIE_KNOWLEDGE_LAYERS"
ENV_IDENTITY = {
    "contributor": "MINDIE_KNOWLEDGE_CONTRIBUTOR",
    "origin_repo": "MINDIE_KNOWLEDGE_ORIGIN_REPO",
}
ENV_BACKEND = "MINDIE_KNOWLEDGE_BACKEND"
ENV_STATE = "MINDIE_KNOWLEDGE_STATE"

CONFIG_BASENAMES = ("mindie-knowledge.json", "mindie-knowledge.yaml", "mindie-knowledge.yml")
...
def shared_source() -> dict[str, str | None]:
    ...
    from mindie_knowledge.corpus import installed_commit
...
def default_candidate_root() -> Path:
    ...
    return base / "mindie-knowledge" / "candidate"
...
def find_config_file(env: Mapping[str, str], start: Path | None = None) -> Path | None:
    ...
    candidates.append(cwd / ".mindie-local" / "knowledge" / "service.json")
    for basename in CONFIG_BASENAMES:
        candidates.append(cwd / basename)
        candidates.append(cwd / ".vaws" / basename)
        candidates.append(config_home / "mindie-knowledge" / basename)
